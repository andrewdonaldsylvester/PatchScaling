from display_data import generate_coordinates
# from display_data import generate_coordinates, display_shape
import time
import matplotlib.pyplot as plt
from animated_shape_display import plot_quiver
    ...
    def animate_scaling(self):
        ...
        while min(d_lengths) < 1:
            for j in range(self.num_edges):
                ...
                # plot_quiver(x_pos, y_pos, x_dir, y_dir, label='Data', pause_time=0.2, color="blue")

                plot_quiver(x_pos, y_pos, x_dir, y_dir, initial_edge_coords, label='Data', pause_time=0.1)
...
if __name__ == "__main__":
    ...
    # test_edge_data_shifted = [[3, +1], [3, +1], [8, +1], [13, +1], [8, +1], [3, +1],
    ...
    #     print("Edge number " + str(i) + ": ")
    #     print(P.edges[i].length)
    #     print(P.edges[i].turning)
    #
    # print("Final data:")
    #
    # for i in range(P.num_edges):
    ...
    # scaled_shape_coords, x, y, z = generate_coordinates(P.generate_edge_data())
    #
    # # Creating plot
    # fig, ax = plt.subplots(figsize=(12, 7))
    # ax.quiver(init_shape_coords, a, b, c,
    #           scale=16)
    #
    # ax.axis([-8, 8, -8, 8])
    # ax.set_aspect('equal')
